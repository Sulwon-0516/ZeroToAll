...
CHECKPOINT_PATH = "./Chapter11/model/checkpoints/tiny_imageNet"
BATCH_SIZE = 32
LEARNING_RATE = 0.045
EPOCH = 1
...
def main():
    ...
    model = exercise11_1.Inception_v4()
    ...
    optimizer = torch.optim.RMSprop(model.parameters(),lr = LEARNING_RATE, alpha = 0.9, eps = 1.0)
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size = 0.94)
    ...
    with torch.no_grad():
        model = exercise11_1.exercise_CNN()
